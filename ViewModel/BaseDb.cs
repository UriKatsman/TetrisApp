...
namespace ViewModel
{
    public abstract class BaseDb
    {
        ...
        //C:\Users\student.HP-6HYJCV2\Downloads\TetrisApp (3)\TetrisApp\ViewModel


        //C:\Users\student.HP-6HYJCV2\Downloads\TetrisApp (3)\TetrisApp\MyAPI\TetrisApp\ViewModel\TetrisNMore.accdb
        ...
        public BaseDb()
        {
            ...
            if (!BaseDb.formated)
            {
                ...
                for (i = ThisPath.Length - 1; i >= 0 && count != 4; i--)
                {
                    if (ThisPath[i] == '\\')
                        count++;
                }

                ThisPath = ThisPath.Substring(0, i + 1);
